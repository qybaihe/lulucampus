...
enum FormalNodeRegistry {
    static let all: [FormalNodeDefinition] = [
        ...
        d(.b2, "Lulu Hermes 问答", .route(path: "/today/ask", component: "HermesAskView"), "screen-B2-hermes"),
        ...
        d(.g1, "Lulu Hermes 唤起", .systemEvent(event: "today hermes entry", component: "HermesAskView"), "today-hermes-entry"),
